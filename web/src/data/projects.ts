...
export const projects: Project[] = [
  {
    ...
    images: [{ url: "/images/hangful/demo.png", label: "App Demo" }],
    links: [{ type: "live", url: "https://hangful.com", label: "Visit Hangful" }],
  ...
  },
  {
    ...
    media: {
      type: "video",
      url: "/videos/gemini/demo.mp4",
      thumbnail: "/images/gemini/monkeyyy.png",
    },
    images: [
    ...
    links: [
      {
        type: "live",
        url: "https://geminiclone-blue-sigma.vercel.app",
        label: "Try it",
      },
      {
        type: "github",
        url: "https://github.com/linder0/geminiclone",
        label: "GitHub",
      },
    ],
  ...
  },
  {
    ...
    images: [{ url: "/images/monography/homepage.png", label: "App Interface" }],
    tweets: [
  ...
  },
  {
    ...
    links: [{ type: "live", url: "https://pookie.work", label: "Visit Pookie" }],
  ...
  },
  {
    ...
    media: {
      type: "video",
      url: "/videos/chimes/chimes-demo.mp4",
      thumbnail: "/images/chimes/chimes-thumb.jpg",
    },
    images: [
  ...
  },
  {
    ...
    media: {
      type: "video",
      url: "https://youtu.be/Y2sF_TRmMb8",
      thumbnail: "/images/petri-dishes/petri-dishes-thumb.jpg",
    },
    images: [{ url: "/images/petri-dishes/petri-dishes.png", label: "Prototype" }],
    links: [],
  ...
  },
  {
    ...
    media: {
      type: "video",
      url: "https://youtu.be/Tnka10wFpD8",
      thumbnail: "/images/nanostalgia/nanostalgia-thumb.jpg",
    },
    images: [
  ...
  },
  {
    ...
    tagline:
      "Behavioral and physiological effects of isolation on G. Portentosa",
    description:
