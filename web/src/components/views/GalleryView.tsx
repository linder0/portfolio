...
import { getCategoryColor, GOLDEN_COLOR } from "@/lib/graphLayout";
import { useScrollLockOnMount } from "@/hooks/useScrollLock";

const NetworkCanvas = dynamic(
  () =>
    import("@/components/NodeNetwork/NetworkCanvas").then((m) => m.default),
  { ssr: false },
);
...
export default function GalleryView() {
  ...
  return (
    <main className="h-screen overflow-hidden relative bg-theme">
      ...
      >
        {(categories as readonly string[]).map((category) => {
