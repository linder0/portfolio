...
export async function Sidebar() {
  ...
  return (
    <>
      ...
      <nav
        aria-label="Primary"
        className="fixed inset-x-0 bottom-0 z-40 flex h-[calc(3rem+env(safe-area-inset-bottom))] border-t border-border bg-background pb-[env(safe-area-inset-bottom)] lg:hidden"
      >
        <a
          href={rootUrl(host)}
